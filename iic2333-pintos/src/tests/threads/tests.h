...
extern test_func test_priority_high_load;
extern test_func test_priority_high_load_yield;
extern test_func test_priority_sema;
extern test_func test_priority_swap;
...
extern test_func test_n;
extern test_func test_a;
