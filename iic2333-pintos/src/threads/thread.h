...
#include <list.h>
#include <stdint.h>
extern int current_queue;
extern bool next_queue;
extern int turns_passed;
extern int queue_number;
extern int max_turns_in_queue;
extern int A;
extern int B;
...
int get_queue(struct thread*);
int get_age(struct thread*);
